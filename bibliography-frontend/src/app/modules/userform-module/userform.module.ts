...
import { UserformCreateComponent } from './module-src/components/userform-create/userform-create.component'
...
@NgModule({
	...
	exports: [UserFormListComponent, UserFormSearchComponent, UserformCreateComponent],
