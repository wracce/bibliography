...
import { BookCreateComponent } from './module-src/components/book-create/book-create.component'

@NgModule({
	declarations: [BookListComponent, BookSearchComponent, SearchPipe, BookCreateComponent],
	imports: [
		CommonModule,
		TuiTableModule,
		TuiButtonModule,
	...
	exports: [BookListComponent, BookSearchComponent, BookCreateComponent],
