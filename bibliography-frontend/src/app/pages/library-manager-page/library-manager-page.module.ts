...
import { BookAddingJournalTabComponent } from './layouts/book-adding-journal-tab/book-adding-journal-tab.component'
import { BookLendingJournalTabComponent } from './layouts/book-lending-journal-tab/book-lending-journal-tab.component'
...
@NgModule({
	...
	bootstrap: [LibraryManagerPageComponent],
})
